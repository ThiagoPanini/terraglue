...
variable "glue_main_script_path" {
  description = "Name of the python file to be assumed as the main Spark application script for the Glue job. The path reference is the root Terraform module where terraglue is called"
  type        = string
